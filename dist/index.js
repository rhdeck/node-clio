(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('stream'), require('http'), require('url'), require('https'), require('zlib'), require('util'), require('path'), require('fs'), require('crypto')) :
  typeof define === 'function' && define.amd ? define(['exports', 'stream', 'http', 'url', 'https', 'zlib', 'util', 'path', 'fs', 'crypto'], factory) :
  (global = global || self, factory(global.index = {}, global.Stream$2, global.http, global.Url, global.https, global.zlib, global.util, global.path$1, global.fs, global.crypto));
}(this, function (exports, Stream$2, http, Url, https, zlib, util, path$1, fs, crypto) { 'use strict';

  Stream$2 = Stream$2 && Stream$2.hasOwnProperty('default') ? Stream$2['default'] : Stream$2;
      ...
      return regenerator.wrap(function _callee5$(_context5) {
        while (1) {
          switch (_context5.prev = _context5.next) {
            case 0:
              path = _ref8.path, fields = _ref8.fields, accessToken = _ref8.accessToken, args = objectWithoutProperties(_ref8, ["path", "fields", "accessToken"]);
              headers = {
                Authorization: "Bearer ".concat(accessToken)
              };
              url = new URL(baseUrl);
  ...
  function () {
    ...
    /*#__PURE__*/
    regenerator.mark(function _callee7(_ref15) {
      var path, fields, data, tempBody, accessToken, args, url, headers, body, ret;
      return regenerator.wrap(function _callee7$(_context7) {
        while (1) {
          switch (_context7.prev = _context7.next) {
            case 0:
              path = _ref15.path, fields = _ref15.fields, data = _ref15.data, tempBody = _ref15.body, accessToken = _ref15.accessToken, args = objectWithoutProperties(_ref15, ["path", "fields", "data", "body", "accessToken"]);
              url = new URL(baseUrl);
              headers = {
                Authorization: "Bearer ".concat(accessToken),
  ...
  function () {
    ...
    /*#__PURE__*/
    regenerator.mark(function _callee8(_ref19) {
      var path, id, fields, accessToken, args, headers, url, ret;
      return regenerator.wrap(function _callee8$(_context8) {
        while (1) {
          switch (_context8.prev = _context8.next) {
            case 0:
              path = _ref19.path, id = _ref19.id, fields = _ref19.fields, accessToken = _ref19.accessToken, args = objectWithoutProperties(_ref19, ["path", "id", "fields", "accessToken"]);
              headers = {
                Authorization: "Bearer ".concat(accessToken)
              };
              url = new URL(baseUrl);
  ...
  function () {
    ...
    /*#__PURE__*/
    regenerator.mark(function _callee9(_ref23) {
      var etag, path, id, fields, data, accessToken, args, headers, url, body, ret;
      return regenerator.wrap(function _callee9$(_context9) {
        while (1) {
          switch (_context9.prev = _context9.next) {
            case 0:
              etag = _ref23.etag, path = _ref23.path, id = _ref23.id, fields = _ref23.fields, data = _ref23.data, accessToken = _ref23.accessToken, args = objectWithoutProperties(_ref23, ["etag", "path", "id", "fields", "data", "accessToken"]);
  ...
  function () {
    ...
    /*#__PURE__*/
    regenerator.mark(function _callee10(_ref27) {
      var path, id, accessToken, args, headers, url, ret;
      return regenerator.wrap(function _callee10$(_context10) {
        while (1) {
          switch (_context10.prev = _context10.next) {
            case 0:
              path = _ref27.path, id = _ref27.id, accessToken = _ref27.accessToken, args = objectWithoutProperties(_ref27, ["path", "id", "accessToken"]);
              headers = {
                Authorization: "Bearer ".concat(accessToken)
              };
              url = new URL(baseUrl);
  ...
  function () {
    ...
    createClass(Clio, [{
      ...
      value: function () {
        ...
        /*#__PURE__*/
        regenerator.mark(function _callee12(_ref32) {
      ...
      value: function () {
        ...
        /*#__PURE__*/
        regenerator.mark(function _callee17(_ref35) {
      ...
      value: function () {
        ...
        /*#__PURE__*/
        regenerator.mark(function _callee18(_ref36) {
      ...
      value: function () {
        ...
        /*#__PURE__*/
        regenerator.mark(function _callee19(_ref37) {
      ...
      value: function () {
        ...
        /*#__PURE__*/
        regenerator.mark(function _callee20(_ref38) {
      ...
      value: function () {
        ...
        /*#__PURE__*/
        regenerator.mark(function _callee21(_ref39) {
      ...
      value: function () {
        ...
        /*#__PURE__*/
        regenerator.mark(function _callee22(type, id) {
          var fields,
              properties,
              _args22 = arguments;
      ...
      value: function () {
        ...
        /*#__PURE__*/
        regenerator.mark(function _callee23(request) {
      ...
      value: function () {
        ...
        /*#__PURE__*/
        regenerator.mark(function _callee24(_ref40) {
          var _this = this;
          ...
          return regenerator.wrap(function _callee24$(_context24) {
            while (1) {
              switch (_context24.prev = _context24.next) {
                case 0:
                  url = _ref40.url, path = _ref40.path, fields = _ref40.fields, args = objectWithoutProperties(_ref40, ["url", "path", "fields"]);
      ...
      value: function () {
        ...
        /*#__PURE__*/
        regenerator.mark(function _callee25(_ref42, f) {
          ...
          return regenerator.wrap(function _callee25$(_context25) {
            while (1) {
              switch (_context25.prev = _context25.next) {
                case 0:
                  path = _ref42.path, fields = _ref42.fields, args = objectWithoutProperties(_ref42, ["path", "fields"]);
                  _context25.next = 3;
      ...
      value: function () {
        ...
        /*#__PURE__*/
        regenerator.mark(function _callee26(_ref43, f) {
      ...
      value: function () {
        ...
        /*#__PURE__*/
        regenerator.mark(function _callee27(_ref44, f) {
          var _this2 = this;
          ...
          return regenerator.wrap(function _callee27$(_context27) {
            while (1) {
              switch (_context27.prev = _context27.next) {
                case 0:
                  path = _ref44.path, fields = _ref44.fields, args = objectWithoutProperties(_ref44, ["path", "fields"]);
      ...
      value: function () {
        ...
        /*#__PURE__*/
        regenerator.mark(function _callee28(_ref45) {
      ...
      value: function () {
        ...
        /*#__PURE__*/
        regenerator.mark(function _callee31(_ref47) {
          var _this3 = this;
              ...
              switch (_context31.prev = _context31.next) {
                case 0:
                  ...
                  return _context31.abrupt("return", {
                    ...
                    asyncToGenerator(
                    /*#__PURE__*/
                    regenerator.mark(function _callee29() {
                    ...
                    asyncToGenerator(
                    /*#__PURE__*/
                    regenerator.mark(function _callee30() {
      ...
      value: function () {
        ...
        /*#__PURE__*/
        regenerator.mark(function _callee32(_ref52) {
          var url, request, res;
      ...
      value: function () {
        ...
        /*#__PURE__*/
        regenerator.mark(function _callee33(_ref53) {
      ...
      value: function () {
        ...
        /*#__PURE__*/
        regenerator.mark(function _callee34(_ref55) {
  ...
  function () {
    ...
    createClass(ClioEntity, [{
      ...
      value: function () {
        ...
        /*#__PURE__*/
        regenerator.mark(function _callee35(changes) {
          var ret;
