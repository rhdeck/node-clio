(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('stream'), require('http'), require('url'), require('https'), require('zlib'), require('util'), require('path'), require('fs')) :
  typeof define === 'function' && define.amd ? define(['exports', 'stream', 'http', 'url', 'https', 'zlib', 'util', 'path', 'fs'], factory) :
  (global = global || self, factory(global.index = {}, global.Stream$2, global.http, global.Url, global.https, global.zlib, global.util, global.path$1, global.fs));
}(this, function (exports, Stream$2, http, Url, https, zlib, util, path$1, fs) { 'use strict';
